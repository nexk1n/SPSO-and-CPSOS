...
for n = 1:50
    % Use Rastrigin as the objective function
    % Random initialization of 100 particles in the range [-5.12, 5.12] dimension 10
    partcles_SPSO = rand(100, 10) * 10.24 - 5.12;
    partcles_CPSOS = rand(100, 10) * 10.24 - 5.12;
...
legend('SPSO', 'CPSOS');
title('Average best fitness of all iterations of SPSO and CPSOS (Rastringin))');
